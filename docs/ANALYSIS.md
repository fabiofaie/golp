...
Tracciamento delle analisi diagnostiche (eq-analyze). Status: `OPEN` (in corso) · `ANALYZED` (completata) · `ACTIONED` (sfociata in azione) · `DISMISSED` (non-issue).

| ID     | Titolo                                                              | Stato    | Created    | Next step suggerito                                              |
|--------|----------------------------------------------------------------------|----------|------------|--------------------------------------------------------------------|
